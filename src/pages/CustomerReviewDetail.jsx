...
const CustomerReviewDetail = () => {
  ...
  useEffect(() => {
    if (!productFromState) {
      ...
      if (
        productFromState.rating !== null &&
        productFromState.rating !== undefined
      ) {
    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="relative z-10 flex-1 ml-52 mx-4 my-4 mr-6">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div
            className="border-2 border-red-800 rounded-lg p-4 mb-6"
            style={insetShadowStyle}
          >
            <h3 className="text-sm text-red-800 font-bold mb-4 border-b border-gray-200 pb-2">
              Detail Pesanan
            </h3>
          ...
          <div
            className="border-2 border-red-800 rounded-lg p-4"
            style={insetShadowStyle}
          >
            ...
            {viewOnly ? (
              <p className="whitespace-pre-wrap border border-gray-300 rounded-lg p-3 bg-gray-100 text-gray-700 min-h-[128px]">
                {comment || "-"}
              </p>
            ) : (
              <textarea
        ...
        {error && (
          <div className="px-6 pb-6 text-red-600 font-semibold">{error}</div>
        )}
        {successMsg && (
          <div className="px-6 pb-6 text-green-600 font-semibold">
            {successMsg}
          </div>
        )}
      </div>
