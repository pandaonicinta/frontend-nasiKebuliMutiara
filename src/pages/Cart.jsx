...
const Cart = () => {
  ...
  const allSelected =
    ...
    cartItems.every((item) =>
      selectedItems.includes(item.cart_item_id || item.id)
    );
  ...
  const handleDecreaseQuantity = (id, size, currentQty) =>
    handleChangeQuantity(id, size, currentQty, "decrease");
  const handleIncreaseQuantity = (id, size, currentQty) =>
    handleChangeQuantity(id, size, currentQty, "increase");
      ...
      <div className="container mx-auto px-4 md:px-8 py-8">
        <div className="flex justify-between items-center mb-8">
          ...
          <p className="text-gray-600">
            ({cartCount} {cartCount === 1 ? "Item" : "Menu"})
          </p>
        </div>
        ...
        {!isAuthenticated && cartCount > 0 && (
          <div className="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-lg">
            <p className="text-amber-700 text-sm">
              <span className="font-bold">Note:</span> You are not logged in.
              Your cart items are saved locally.
              <a href="/login" className="ml-1 text-amber-700 underline">
                Login
              </a>{" "}
              to save your cart items to your account.
            </p>
          </div>
        )}
            ...
            {cartItems.length === 0 ? (
              ...
              <>
                  ...
                  {cartItems.map((item) => {
                    ...
                    return (
                      <div
                        ...
                        className="grid md:grid-cols-12 gap-2 py-4 border-b items-center"
                      >
                ...
                <div className="mt-8 flex justify-between">
                  ...
                  >
                    <HiOutlineArrowNarrowLeft className="mr-2" /> Lanjutkan
                    Belanja
                  </button>
                  {/* <button
