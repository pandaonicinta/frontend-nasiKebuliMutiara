...
const Home = () => {
  return (
    <div className="min-h-screen">
      ...
      <div className="bg-gradient-to-r from-[#EFECD7] via-[#FCFBF5] to-[#F9EAEA]">
        ...
        <nav className="flex justify-between items-center px-24 py-5">
          ...
          <div className="flex items-center space-x-10">
            ...
            <a href="/about" className="text-gray-800 font-medium hover:text-yellow-500">About Us</a>
      ...
      {/* Categories Section - Updated to match the design in photo */}
      <section className="py-16 bg-white">
        <div className="container mx-auto px-8">
          ...
          {/* Updated Card Grid with button styling for names */}
          <div className="flex justify-center gap-6 px-4">
            ...
            <div className="rounded-lg shadow-xl overflow-hidden w-64 transform transition-transform hover:scale-105">
              <div className="overflow-hidden bg-gradient-to-br from-yellow-300 via-yellow-100 to-white">
                <img src={foto} alt="Nasi Kebuli" className="w-full h-48 object-cover" />
              </div>
              <div className="relative">
                <div className="bg-white p-4">
                  <div className="flex justify-between items-center bg-white border border-gray-200 rounded-md px-3 py-2">
                    <h3 className="font-medium text-gray-800">Nasi Kebuli</h3>
            ...
            <div className="rounded-lg shadow-xl overflow-hidden w-64 transform transition-transform hover:scale-105">
              <div className="overflow-hidden bg-gradient-to-br from-yellow-300 via-yellow-100 to-white">
                <img src={foto} alt="Paket Nampan Ayam" className="w-full h-48 object-cover" />
              </div>
              <div className="relative">
                <div className="bg-white p-4">
                  <div className="flex justify-between items-center bg-white border border-gray-200 rounded-md px-3 py-2">
                    <h3 className="font-medium text-gray-800">Paket Nampan Ayam</h3>
                    <FiArrowRight className="text-yellow-500" />
                  </div>
                </div>
              </div>
            ...
            <div className="rounded-lg shadow-xl overflow-hidden w-64 transform transition-transform hover:scale-105">
              <div className="overflow-hidden bg-gradient-to-br from-yellow-300 via-yellow-100 to-white">
                <img src={foto} alt="Paket Nampan Kambing" className="w-full h-48 object-cover" />
              </div>
              <div className="relative">
                <div className="bg-white p-4">
                  <div className="flex justify-between items-center bg-white border border-gray-200 rounded-md px-3 py-2">
                    <h3 className="font-medium text-gray-800">Paket Nampan Kambing</h3>
                    <FiArrowRight className="text-yellow-500" />
                  </div>
                </div>
              </div>
            ...
            <div className="rounded-lg shadow-xl overflow-hidden w-64 transform transition-transform hover:scale-105">
              <div className="overflow-hidden bg-gradient-to-br from-yellow-300 via-yellow-100 to-white">
                <img src={foto} alt="Paket Nampan Sapi" className="w-full h-48 object-cover" />
              </div>
              <div className="relative">
                <div className="bg-white p-4">
                  <div className="flex justify-between items-center bg-white border border-gray-200 rounded-md px-3 py-2">
                    <h3 className="font-medium text-gray-800">Paket Nampan Sapi</h3>
                    <FiArrowRight className="text-yellow-500" />
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-8">
          <div className="flex justify-between items-center">
            <div className="w-1/2 relative z-10">
              ...
              <a href="#ramadhan-deal" className="px-8 py-4 bg-red-800 text-white rounded-full hover:bg-red-900 shadow-lg transition duration-300 inline-flex items-center">
