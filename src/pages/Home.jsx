...
const Home = () => {
  ...
  const categories = [
    ...
    {
      id: 2,
      name: "Paket Nampan Ayam",
      image: nampanayam,
      slug: "paket-nampan-ayam",
    },
    {
      id: 3,
      name: "Paket Nampan Kambing",
      image: nampankambing,
      slug: "paket-nampan-kambing",
    },
    {
      id: 4,
      name: "Paket Nampan Sapi",
      image: nampansapi,
      slug: "paket-nampan-sapi",
    },
  ];
      ...
      try {
        ...
        allReviews.forEach((review) => {
          ...
          if (productReviewCount[productId]) {
            ...
            productReviewCount[productId].totalRating += parseInt(
              review.rating_value
            );
  ...
  useEffect(() => {
    const fetchReviews = async () => {
      try {
        ...
        const fiveStarReviews = response.data.filter(
          (review) => parseInt(review.rating_value) === 5
        );
        ...
        fiveStarReviews.forEach((review) => {
          if (!reviewsByUser[review.name]) {
            ...
            const existingReviewWordCount =
              reviewsByUser[review.name].comment.split(" ").length;
    ...
    <div className="min-h-screen">
      <div className="bg-gradient-to-r from-[#EFECD7] via-[#FCFBF5] to-[#F9EAEA]">
        ...
        <nav className="flex justify-between items-center px-24 py-5">
          ...
          <div className="flex items-center space-x-10">
            ...
            <Link
              to="/cart"
              className="text-gray-800 hover:text-yellow-500 relative"
            >
        ...
        <section className="flex justify-between items-center px-28 py-16">
          <div className="w-1/2 pr-8">
            <div className="flex items-center mb-4">
              ...
              <h1 className="text-4xl font-extrabold font-berkshire text-gray-800">
                Selamat Datang
              </h1>
            </div>
            <div className="mb-8">
              <h2 className="text-7xl font-berkshire text-gray-900 leading-tight">
                <span className="text-gray-900">Nasi</span>{" "}
                <span className="text-yellow-500">Kebuli</span>
              </h2>
              <h2 className="text-7xl font-berkshire text-gray-900 leading-tight">
            ...
            <p className="text-lg text-gray-700 mb-8 max-w-lg">
              Nasi Kebuli Mutiara menyajikan nasi kebuli autentik dengan cita
              rasa rempah khas Timur Tengah. Disajikan lengkap dengan daging
              empuk, sambal, acar, dan kerupuk renyah. Cocok untuk pecinta
              kuliner khas dan lezat!
            </p>
            <Link
              to="/menu"
              className="px-8 py-4 bg-yellow-500 text-white rounded-full hover:bg-yellow-600 shadow-lg transition duration-300 inline-flex items-center"
            >
              Jelajahi Cita Rasa Autentik Kami
          ...
          <div className="w-1/2 flex justify-center">
            <img
              src={foto}
              alt="Nasi Kebuli"
              className="w-5/6 h-auto rounded-full shadow-xl"
            />
          </div>
        </section>
        ...
        <div className="wave-divider relative h-32">
          ...
          >
            <path
              d="M0,64 C40,80 80,48 120,64 C160,80 200,48 240,64 C280,80 320,48 360,64 C400,80 440,48 480,64 C520,80 560,48 600,64 C640,80 680,48 720,64 C760,80 800,48 840,64 C880,80 920,48 960,64 C1000,80 1040,48 1080,64 C1120,80 1160,48 1200,64 C1240,80 1280,48 1320,64 C1360,80 1400,48 1440,64 L1440,120 L0,120 Z"
              fill="white"
            ></path>
          </svg>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-8">
          ...
          <p className="text-center text-gray-500 mb-12">
            Jelajahi berbagai kategori menu kami untuk menemukan nasi kebuli
            favoritmu.
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-8">
          ...
          <p className="text-center text-gray-500 mb-12">
            Baca review dari mereka yang telah menikmati kebuli buatan tangan
            kami.
          </p>
                ...
                >
                  ...
                  <div className="mt-auto">
                    ...
                    <div className="text-sm">
                      <span className="font-semibold text-gray-400 text-s">
                        Menu:
                      </span>
                      <Link
                        to={`/menu/${testimonial.produk_id}`}
                        className="text-gray-400 text-s underline ml-1"
                      >
              ...
              <div className="grid grid-cols-2 gap-x-4">
                <ul className="space-y-2">
                  <li>
                    <Link
                      to="/"
                      className="hover:text-yellow-400 flex items-center text-xs"
                    >
              ...
              <div className="flex flex-col md:flex-row md:justify-between">
                  ...
                  <div className="flex items-start mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs max-w-xs">
                        Jl. Villa Mutiara Cikarang blok H10, No.37, Ciantra,
                        Cikarang Sel. Kab. Bekasi, Jawa Barat 17530
                      </p>
                    </div>
                  </div>
                ...
                <div className="mt-4 md:mt-0 flex items-start md:justify-end">
                  <div className="flex space-x-3">
                    <a
                      href="https://facebook.com/https://www.facebook.com/kebuli.mutiara"
                    ...
                    <a
                      href="https://instagram.com/https://www.instagram.com/kebuli_mutiara?igsh=d2p1M2Rid2J3dTB6"
                      className="bg-red-800 p-1.5 rounded-md hover:bg-red-700 transition-colors"
                    ...
                    <a
                      href="https://wa.me/6285775579055"
                      className="bg-red-800 p-1.5 rounded-md hover:bg-red-700 transition-colors"
                      aria-label="WhatsApp"
                      target="_blank"
                      rel="noopener noreferrer"
      ...
      <div className="bg-red-900 text-white text-center py-3 px-6 md:px-20 lg:px-32">
        ...
        <div className="container mx-auto">
          <p className="text-xs">
            Copyright © 2025 Kebuli Mutiara. All rights reserved.
          </p>
        </div>
      </div>
    </div>
