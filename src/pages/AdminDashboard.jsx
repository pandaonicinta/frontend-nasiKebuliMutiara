...
const AdminDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const performanceResponse = await axios.get(
        "http://eggsperts.my.id/api/dashboard/report",
        { headers }
      );
  ...
  const calculateChartData = () => {
    ...
    if (total === 0)
      return { totalPercent: 0, onDeliveryPercent: 0, deliveredPercent: 0 };
          ...
          <>
                    ...
                    <div className="ml-4">
                      <div className="flex flex-col space-y-2">
                        <div className="flex items-center">
                          ...
                          <p className="text-xs">
                            Total: {orderSummary.totalOrder}
                          </p>
                        </div>
                        <div className="flex items-center">
                          <div className="w-3 h-3 bg-blue-500 rounded-full mr-2"></div>
                          <p className="text-xs">
                            Sedang Diantar: {orderSummary.onDelivery}
                          </p>
                        </div>
                        <div className="flex items-center">
                          <div className="w-3 h-3 bg-green-500 rounded-full mr-2"></div>
                          <p className="text-xs">
                            Selesai: {orderSummary.delivered}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  {performanceData.map((item, index) => (
                    <div key={index} className="flex flex-col items-center">
                      <div
                        ...
                        style={{
                          height: `${
                            maxValue > 0 ? (item.value / maxValue) * 120 : 0
                          }px`,
            ...
            <div className="mt-6 bg-white rounded-lg shadow-lg">
              <div className="flex justify-between items-center p-4 border-b border-gray-200 ">
                ...
                <a
                  href="/admin/orders"
                  className="text-white bg-red-800 px-3 py-1 rounded text-xs font-bold"
                >
                  LIHAT SEMUA
                </a>
              </div>
