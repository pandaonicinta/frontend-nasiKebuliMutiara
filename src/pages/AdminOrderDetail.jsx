    ...
    const fetchOrderDetails = async (id) => {
      try {
        ...
        const response = await axios.get(
          `${API_BASE_URL}/api/transaksiAdmin/${id}`,
          {
        ...
        const order = orders.find((o) => String(o.transaksi_id) === String(id));
        ...
        if (
          processedOrder.keranjang &&
          Array.isArray(processedOrder.keranjang)
        ) {
                  ...
                  <div className="border-2 border-red-800 rounded-lg p-3">
                    <div className="mb-3">
                      <div className="flex justify-between mb-2">
                        ...
                        <span className="text-xs font-bold">
                          #{orderDetails.transaksi_id}
                        </span>
                      </div>
                      <div className="flex justify-between mb-2">
                        <span className="text-xs text-gray-700">Date</span>
                        <span className="text-xs font-bold">
                          {formatDate(orderDetails.tanggal_pembelian)}
                        </span>
                      </div>
                      <div className="flex justify-between mb-2">
                        ...
                        <span className="text-xs font-bold">
                          {orderDetails.keranjang.length}
                        </span>
                      </div>
                      <div className="flex justify-between mb-2">
                        <span className="text-xs text-gray-700">Customer</span>
                        <span className="text-xs font-bold">
                          {orderDetails.nama_pembeli}
                        </span>
                      </div>
                      ...
                      {orderDetails.alamat && (
                        <>
                          <div className="flex justify-between mb-2">
                            ...
                            <span className="text-xs font-bold">
                              {orderDetails.alamat.nama_penerima}
                            </span>
                          </div>
                          <div className="flex justify-between mb-2">
                            <span className="text-xs text-gray-700">Phone</span>
                            <span className="text-xs font-bold">
                              {orderDetails.alamat.no_telepon}
                            </span>
                          </div>
                          <div className="flex justify-between mb-2">
                            <span className="text-xs text-gray-700">
                            ...
                            <span className="text-xs font-bold">
                              {orderDetails.alamat.label_alamat}
                            </span>
                          </div>
                          <div className="flex justify-between mb-2">
                            <span className="text-xs text-gray-700">
                            ...
                            <span className="text-xs font-bold text-right max-w-xs">
                              {orderDetails.alamat.detail}
                            </span>
                          </div>
                          <div className="flex justify-between mb-2">
                            <span className="text-xs text-gray-700">Area</span>
                            <span className="text-xs font-bold text-right max-w-xs">
                              {orderDetails.alamat.kelurahan},{" "}
                              {orderDetails.alamat.kecamatan},{" "}
                              {orderDetails.alamat.kabupaten},{" "}
                              {orderDetails.alamat.provinsi}
                            </span>
                          </div>
                    ...
                    <div className="mt-3 pt-3 border-t border-gray-200">
                      ...
                      <div className="flex justify-between mb-1">
                        ...
                        <span className="text-xs font-bold">
                          Rp.{" "}
                          {(Number(orderDetails.subtotal) || 0).toLocaleString(
                            "id-ID"
                          )}
                        </span>
                      </div>
                      ...
                      <div className="flex justify-between pt-2 border-t border-gray-200">
                        ...
                        <span className="text-xs font-bold text-red-800">
                          Rp.{" "}
                          {(
                            Number(orderDetails.total_harga) || 0
                          ).toLocaleString("id-ID")}
                        </span>
                      </div>
                      {orderDetails.calculatedTotal !==
                        Number(orderDetails.total_harga) && (
                        <div className="flex justify-between">
                          ...
                          <span className="text-xs text-gray-500">
                            Rp.{" "}
                            {(
                              Number(orderDetails.calculatedTotal) || 0
                            ).toLocaleString("id-ID")}
                          </span>
                        </div>
                      )}
