    ...
    const fetchMenuItems = async () => {
      try {
        ...
        if (response.data && Array.isArray(response.data)) {
          ...
          const uniqueCategories = [{ id: "all", name: "Semua", slug: "all" }];
    ...
    if (activeCategory !== "all") {
      ...
      if (categoryObj) {
        items = items.filter(
          (item) =>
            item.kategori &&
            item.kategori.toLowerCase() === categoryObj.name.toLowerCase()
        );
      }
    }
    ...
    <div className="min-h-screen bg-[#F9F7F0]">
      ...
      <header className="bg-white">
        <nav className="flex justify-between items-center px-24 py-5">
          ...
          <div className="flex items-center space-x-10">
            ...
            <a href="/menu" className="text-yellow-500 font-medium">
              Menu
            </a>
            <div className="relative">
              <input
      ...
      <section className="pt-16 pb-12 px-6 md:px-16 lg:px-24 text-center">
        <h1 className="text-6xl font-berkshire mb-6">
          ...
          <span className="text-[#FDC302]">Kami</span>
        </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {loading ? (
              Array.from({ length: 6 }, (_, index) => (
                <div
                  key={index}
                  className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 w-full max-w-xs mx-auto h-[450px]"
                >
